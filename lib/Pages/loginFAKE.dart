...
import 'home.dart';    //como esta en el mismo directorio puedes solo escribir el nombre que quieres importar
...
class _LoginState extends State<Login> {
  ...
  void isSignedIn() async{
    ...
    if (isLogedin){                                             //poner solo if (isLogedin) es lo mismo que poner.... if (isLogedin == ture)
...
.authentication;
    ...
    if (firebaseUser != null) {
      ...
      if(documents.length == 0){  // esto quiere decir que le usuario no se encuentra en la base de datos
        /// insertar usuario a nuestra coleccion
        Firestore.instance
            .collection("users")
        ...
        await preferences.setString("photoUrl", documents[0]['photoUIrl'] );
      }

      Fluttertoast.showToast(msg: "Se loggeo correctamente");
      setState(() {
        loading = false;
      });
      ...
      Fluttertoast.showToast(msg: "No se pudo loggear :(");
    }
  }
...
//TODO:: make the logo show
          ...
          Container(
              ...
              child: Image.asset('Imagenes/Login/LogoSoccer.png', width: 220.0, height: 200.0,)),
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Image.asset('Imagenes/Login/google.png', width: 30.0, height: 30.0,),
                                      ),
